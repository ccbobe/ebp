...
<div id="adv">
    <div>
        <a href="index.html">碟派网</a><span>&nbsp;>&nbsp;</span><a href="">登录</a>
    </div>
</div>
<div id="content">
    <div class="idmessage">
            ...
            <div class="id_left_bj">
                ...
                <div class="passwd">
                    ...
                    <table>
                        <tr align="right">
                            <td>帐&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号&nbsp;:&nbsp;</td>
                            <td class="inpt">&nbsp;<input type="text" name="userName" value="${user.userName }"></td>
                        </tr>
                        <tr align="right">
                            <td height="60">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码&nbsp;:&nbsp;</td>
                            <td class="inpt">&nbsp;<input type="password" name="password" value="${user.userName }"></td>
                        </tr>
                        <tr>
                            <td height="40" class="bt" colspan="2" align="center"><input class="input1" type="submit"
                                                                                         value="登&nbsp;录" "><input
                                    type="reset" id="forget" class="input1" value="注&nbsp;册" onclick="window.location='userRegPage'"></td>
                        </tr>
                    </table>
                    </form>
                </div>
