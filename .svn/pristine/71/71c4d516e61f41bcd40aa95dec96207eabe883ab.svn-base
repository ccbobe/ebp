...
<div id="adv">
    <div>
        <a href="index.html">碟派网</a><span>&nbsp;>&nbsp;</span><a href="">账户充值</a>
    </div>
</div>
<div id="content">
    <div class="look_dd">
    ...
    <div class="chongzhi">
        ...
        <table border="0">
            ...
            <tr>
                ...
                <td class="lie">
                    <select class="all1">
                        <option value="yi">空中充值</option>
                        <option value="er">支付宝支付</option>
                        <option value="san">微信支付</option>
                    </select>
                </td>

            </tr>
            <tr>
                <td height="40" align="right" >s充值金额&nbsp;:&nbsp;</td>
                <td class="money"><input type="text" value="" name="balance"></td>
            </tr>
            <tr>
